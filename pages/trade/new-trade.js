...
export default class TRADE_ADS extends Component {
    constructor(props) {
        super(props);
        this.state = {
            trade: 'buy',
    ...
    render() {
        ...
        return (
            <div style={{ fontSize: '30px', flexDirection: 'column', flex: 1, justifyContent: "center", alignItems: 'center', display: "flex" }} >
                <div>
                    NEW Trades
         </div>
                <div>
                ...
                <div>
                <button onClick={this._onCreateAd} style={mystyle_first} >CREATE trade</button>
